...
(function($, window) {
  ...
  Tour = (function() {
    ...
    Tour.prototype.prev = function() {
      var promise;
      promise = this.hideStep(this._current);
      return this._callOnPromiseDone(promise, this._showPriKitchentep);
    };
    ...
    Tour.prototype._showPriKitchentep = function() {
      var promise, showPriKitchentepHelper, step;
      step = this.getStep(this._current);
      showPriKitchentepHelper = (function(_this) {
        return function(e) {
          return _this.showStep(step.prev);
        };
      })(this);
      promise = this._makePromise(step.onPrev != null ? step.onPrev(this) : void 0);
      return this._callOnPromiseDone(promise, showPriKitchentepHelper);
    };
