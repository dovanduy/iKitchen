...
define(function (require) {
	...
	Wizard.prototype = {
		...
		setState: function () {
			...
			var priKitchenelector = '.steps li:lt(' + (this.currentStep - 1) + ')';
			var $priKitchenteps = this.$element.find(priKitchenelector);
			$priKitchenteps.addClass('complete');
			$priKitchenteps.find('span.badge').addClass('badge-success');
